...
import { fetchChapters, selectFilteredChapters } from "@/lib/features/chapters/chaptersSlice"
import ChapterCardEnhanced from "./chapter-card-enhanced"
    ...
    <div className="space-y-4">
      {filteredChapters.length > 0 ? (
        filteredChapters.map((chapter, index) => (
          <ChapterCardEnhanced key={`${chapter.subject}-${chapter.chapter}-${index}`} chapter={chapter} />
        ))
      ) : (
